...
foreach($data as $key =>$value){
	$increase=$value[$days_count]['totalconfirmed']-$value[$days_count_prev]['totalconfirmed']
		?>
		<tr> -->
			<th><?php echo $key; ?></th>
			<!-- <td><?php echo $value[$days_count]['totalconfirmed'];?>
			<?php if($increase !=0)
			{?>
		...
		?>
				...
				<td><?php echo $value[$days_count]['totalrecovered'];?></td>
				<td><?php echo $value[$days_count]['totaldeceased'];?></td>
